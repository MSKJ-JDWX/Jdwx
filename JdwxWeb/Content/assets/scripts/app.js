...
var App = function () {
    ...
    var runResponsiveHandlers = function () {
        ...
        for (var i in responsiveHandlers) {
            if (responsiveHandlers.hasOwnProperty(i)) {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        var containerHeight = clientHeight - 90;//640;

        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            var available_height = $(window).height() - $('.footer').outerHeight();
            if (content.height() < available_height) {
                content.attr('style', 'min-height:' + containerHeight + 'px !important');
            }
        } else {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "/Administration/Content/assets/css/themes/" + color + ".css");
